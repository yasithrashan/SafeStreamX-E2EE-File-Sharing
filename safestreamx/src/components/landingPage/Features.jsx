  ...
  const featuresList = [
    {
      ...
      description: "Files are encrypted using AES-256 before being uploaded and decrypted only when downloaded by the recipient."
    },
    {
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Set expiration times for shared file links to ensure temporary access, enhancing security and control."
    },
    {
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Share encrypted files through secure, expiring, or one-time-use links with optional password protection."
    },
    {
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Comprehensive dashboard to manage files, view uploaded content, and generate or revoke sharing links."
    }
  ];
